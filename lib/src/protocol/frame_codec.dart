...
class FrameCodec {
  ...
  static final Map<String, ControlDecoder> _builtIn = {
    ...
    DriveCredentialRequest.typeName: DriveCredentialRequest.fromJson,
    NodeDriveCredentialRequest.typeName: NodeDriveCredentialRequest.fromJson,
    NodeDriveCredentialResponse.typeName: NodeDriveCredentialResponse.fromJson,
    DriveCredentialResponse.typeName: DriveCredentialResponse.fromJson,
